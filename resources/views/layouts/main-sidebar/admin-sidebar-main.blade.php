<div class="main-sidemenu">
    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg xmlns="http://www.w3.org/2000/svg"
                class="side-menu__icon" viewBox="0 0 24 24">
                <path d="M0 0h24v24H0V0z" fill="none" />
                <path d="M6.26 9L12 13.47 17.74 9 12 4.53z" opacity=".3" />
                <path
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('Service.index') }}">تفاصيل كشوفات الدكاترة</a></li>
                <li><a class="slide-item" href="{{ route('Laboratory_Services.index') }}">تفاصيل فحوصات المختبر</a></li>
                <li><a class="slide-item" href="{{ route('Ray_Services.index') }}">تفاصيل الأشعة</a></li>
                <li><a class="slide-item" href="{{ route('Surgery_Services.index') }}">تفاصيل العمليات الجراحية</a></li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">فواتير الأطباء</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    <circle cx="14.5" cy="7.5" r="1.5" />
                    <circle cx="17.5" cy="11.5" r="1.5" />
                </svg><span class="side-menu__label">فواتير المختبرات</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item" href="#"> الفواتير النقدية</a></li>
                <li><a class="slide-item" href="#"> الفواتير الآجلة (تأمين)</a>
                </li>
            </ul>
        </li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    <circle cx="14.5" cy="7.5" r="1.5" />
                    <circle cx="17.5" cy="11.5" r="1.5" />
                </svg><span class="side-menu__label">فواتير الأشعة</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item" href="#"> الفواتير النقدية</a></li>
                <li><a class="slide-item" href="#"> الفواتير الآجلة (تأمين)</a>
                </li>
