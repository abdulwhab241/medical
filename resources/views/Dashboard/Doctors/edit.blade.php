...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> الأطباء</h4><span
                ...
                <div class="card-body">
                    <form action="{{ route('Doctors.update', 'test') }}" method="post" autocomplete="off"
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            <div>
                                @if($doctor->image)
                                    <img style="border-radius:20%"
                                         src="{{Url::asset('/My/Dashboard/img/doctors/'.$doctor->image->filename)}}"
                                         height="150px" width="150px" alt="">
                                @else
                                    <img style="border-radius:50%"
                                         src="{{Url::asset('/My/Dashboard/img/doctor_default.png')}}"
                                         height="50px"
                                         width="50px" alt="">
                                @endif
                            </div>
                            ...
                            <button type="submit"
                                    class="btn btn-main-primary pd-x-30 mg-r-5 mg-t-5">تعديل البيانات</button>
                        </div>
                    </form>
                </div>
            </div>
