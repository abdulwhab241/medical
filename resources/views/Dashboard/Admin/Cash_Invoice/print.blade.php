...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">طباعة فاتورة نقدية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    طباعه
                    الفواتير</span>
            </div>
        </div>
                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                <label class="tx-gray-600 ">تفاصيل الفاتورة النقدية</label><br>
                                ...
                                <p class="invoice-info-row"><span>تاريخ الفاتورة</span>
                                    <span></span>{{ $Invoice->invoice_date }}
                                </p>
                                ...
                                <p class="invoice-info-row"><span>نوع التعامل</span>
                                    <span></span> {{ $Invoice->status == 1 ? 'نقدي' : 'اجل' }}
                                </p>
                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0" border="1"
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td> {{ number_format($Invoice->total) }}
                                        </td>
                                    </tr>
                                    <tr>
