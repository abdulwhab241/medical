...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المختبر</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة موظفين
                    المختبر</span>
            </div>
        </div>
    </div>
...
@section('content')
    ...
    <div class="row row-sm">
                            ...
                            <tbody>
                                @foreach ($Laboratory_Employees as $Laboratory_Employee)
                                    <tr>
                                        ...
                                        <td>{{ $Laboratory_Employee->phone }}</td>
                                        <td>{{ $Laboratory_Employee->address }}</td>
                                        <td>{{ $Laboratory_Employee->date }}</td>
                                        <td>
                                    ...
                                    @include('Dashboard.Admin.Laboratory_Employee.edit')
                                    @include('Dashboard.Admin.Laboratory_Employee.delete')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
        ...
        @include('Dashboard.Admin.Laboratory_Employee.add')
        <!-- /row -->
