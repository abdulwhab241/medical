...
class SingleInvoices extends Component
{
    ...
    public function render()
    {
        return view('livewire.single_invoices.single-invoices', [
            ...
            'Doctors'=> User::where('disc','دكتور')->get(),
    ...
    public function print($id)
    {
        ...
        return Redirect::route('Print_single_invoices',[
            ...
            'total' => $single_invoice->total_with_tax,
        ]);
    ...
    {
        $doctor_id = User::with('section')->where('id', $this->doctor_id)->first();
    ...
    public function edit($id){
        ...
        $this->doctor_id = $single_invoice->user_doctor_id;
